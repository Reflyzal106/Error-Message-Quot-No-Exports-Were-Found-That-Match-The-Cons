# [SOLVED] Error Message Quot No Exports Were Found That Match The Cons
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/error-message-quot-no-exports-were-found-that-match-the-cons)

---

### 🔍 Quick Technical Overview & Summary:
Check the project references and ensure that all referenced assemblies match the contract names. Rebuild the solution or try repairing the references.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/error-message-quot-no-exports-were-found-that-match-the-cons)**
